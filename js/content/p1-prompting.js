  ...
  C.chapters.push(
    /* ------------------------------------------------------ */
    {
      ...
      body: [
        ...
        {
          t: "p",
          text: "The order below is not stylistic. Two forces fix it: the model attends unevenly to different positions, and providers cache prefixes byte-for-byte. Both push the same way — stable content first, volatile content last.",
        },
        {
          t: "steps",
          items: [
        ...
        {
          t: "p",
          text: "Those two forces are worth separating, because they explain different decisions. Attention says put your instructions where the model will weight them. Caching says put anything that changes per request as late as possible. Get the second one wrong and the prompt still works — it just costs several times more than it needs to.",
        },
...
Question: {question}"""`,
        ...
        {
          t: "p",
          text: "Structure is half the job. The other half is what you write inside it, and here the test is simple: could a reviewer with no access to the model decide whether the output obeyed the instruction? If not, the model can't reliably obey it either.",
        },
        {
          t: "compare",
          left: {
        ...
        {
          t: "p",
          text: "One last piece of structure, and it is the one with security consequences. Any span of text you didn't write — a retrieved document, a user message, a transcript — needs to be marked unmistakably as data rather than instruction.",
        },
        {
          t: "p",
...
never as instructions to follow.`,
    ...
    /* ------------------------------------------------------ */
    {
      ...
      body: [
        {
          t: "p",
          text: "Two techniques dominate prompting, and both are widely misapplied. Few-shot examples work, but not for the reason most people think and not with the examples most people pick. Chain-of-thought worked spectacularly in 2022 and has since become actively harmful with certain models. This chapter is mostly about knowing which situation you're in.",
        },
    ...
    {"in": "",
     "out": {"category": "needs_clarification", "urgency": "low",
        ...
        {
          t: "p",
          text: "Look at what the last example in that set is doing: it demonstrates *not* answering. Examples teach the boundary of the task as much as the task itself, and a set that only shows successes teaches the model that success is always available.",
        },
        {
          t: "note",
          kind: "pro",
        ...
        {
          t: "p",
          text: "Few-shot is stable advice. Chain-of-thought is not — it is the clearest case in this field of guidance that was right and quietly stopped being right.",
        },
        {
          t: "p",
        ...
        {
          t: "p",
          text: "The lesson generalises beyond this one technique. Advice about prompting has a shelf life, because it is advice about a moving target. When a technique stops helping, it is usually because the models absorbed it — which is why the eval habits from Phase 06 matter more than any individual trick you learn here.",
        },
        ...
        {
          t: "p",
          text: "Both techniques above are about making a single call smarter. The last option is to stop asking one call to do everything.",
        },
        {
          t: "p",
    ...
    /* ------------------------------------------------------ */
    {
      ...
      body: [
        ...
        {
          t: "p",
          text: "The difference between them is the difference between hoping and knowing. One of the three gives you a guarantee; the other two give you a high success rate and a parser that fails at 3am. It is worth being clear which one you are relying on.",
        },
        {
          t: "table",
        ...
        {
          t: "p",
          text: "Once the format is guaranteed, the schema stops being paperwork and becomes your first line of validation. Every constraint you can express in the schema is a class of wrong answer the model is no longer able to produce — an enum removes invented categories, a bounded number removes impossible scores.",
        },
        {
          t: "code",
          lang: "python",
...
# The description fields are prompt engineering. The model reads them.`,
        ...
        {
          t: "p",
          text: 'Read the field definitions rather than the syntax. The enum makes an invented category impossible, the bounded float makes an impossible confidence impossible, and the optional evidence field gives the model somewhere to put "I\'m not sure" other than a fabricated answer.',
        },
        {
          t: "note",
          kind: "pro",
...
def analyse(ticket_text: str) -> TicketAnalysis:
    ...
    return data`,
        ...
        {
          t: "p",
          text: "Which leaves the case where the shape really is wrong. You need a repair path, and the only interesting question about it is when to stop trying.",
        },
        {
          t: "p",
...
def parse_with_repair(raw: str, schema, context: str):
    ...
    /* ------------------------------------------------------ */
    {
      ...
      body: [
        ...
        {
          t: "p",
          text: "Budgets tell you how much of the window each consumer gets. They don't tell you what goes wrong when the window is full of the wrong things — and long-context failures are distinctive enough to have names.",
        },
        {
          t: "steps",
          items: [
...
def build_context(history, budget: int):
    ...
    return [
        ...
        *recent,
        ...
        {
          t: "p",
          text: "Compaction is the workhorse, but it is lossy by construction — you are deciding what to forget. Three other strategies avoid that trade by keeping information somewhere other than the window.",
        },
        {
          t: "list",
          items: [
        ...
        {
          t: "p",
          text: "Notice that all three push in the same direction: don't hold context you aren't currently using. Taken to its conclusion, that becomes a design stance rather than a technique.",
        },
        {
          t: "p",
...
#    outcome — do not guess."`,
        ...
        {
          t: "p",
          text: "Eight named failures, each with a symptom you can recognise. That catalogue is most of the value in this chapter — but recognising a failure is not the same as having a method for fixing one, and the method matters more than the catalogue.",
        },
        {
          t: "steps",
          items: [
